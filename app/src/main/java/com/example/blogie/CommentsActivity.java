...
public class CommentsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.meosman.blogie.R.layout.activity_comments);

        commentToolbar = findViewById(com.meosman.blogie.R.id.comment_toolbar);
        ...
        comment_field = findViewById(com.meosman.blogie.R.id.comment_field);
        comment_post_btn = findViewById(com.meosman.blogie.R.id.comment_post_btn);
        comment_list = findViewById(com.meosman.blogie.R.id.comment_list);
